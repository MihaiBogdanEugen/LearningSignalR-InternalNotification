...
//using LearningSignalR.BackEnd.ViewModels.Manage;
...
//                BrowserRemembered = await AuthenticationManager.TwoFactorBrowserRememberedAsync(userId.ToString(NumberFormatInfo.InvariantInfo))
//            };
//            return View(model);
//        }
//
